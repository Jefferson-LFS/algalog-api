...
public class OcorrenciaController {
	...
	private BuscaEntregaService buscaEntregaSerivce;
	private RegistroOcorrenciaService registroOcorrenciaService;
	private OcorrenciaAssembler ocorrecniaAssembler;
	...
	public OcorrenciaModel registrar(@PathVariable Long entregaId,
		...
		return ocorrecniaAssembler.toModel(ocorrenciaRegistrada);
	}
	
	@GetMapping
	public List<OcorrenciaModel> listar(@PathVariable Long entregaId){
		Entrega entrega = buscaEntregaSerivce.buscar(entregaId);
		
		return ocorrecniaAssembler.toCollectionModel(entrega.getOcorrencia());
	}
}
